...
import 'package:takatuf/views/others/list_tile_setting.dart';
...
class SettingScreen extends StatelessWidget {
  ...
  Future<void> _setLanguage(String languageCode, BuildContext context) async {
    ...
    // تحديث اللغة في GetMaterialApp
    Get.updateLocale(Locale(languageCode, ''));  // تحديث اللغة مباشرة

    // في حالة كنت تستخدم easy_localization أيضًا
